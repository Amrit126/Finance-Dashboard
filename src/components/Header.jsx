...
export function Header() {
    ...
    return (
        <>
            <div className="flex justify-between items-center p-4 bg-slate-900 text-white text-4xl border-b-2 
            border-black z-50 relative">
            ...
            flex justify-between md:hidden text-2xl px-4 py-2 transition-all duration-300 absolute bg-white w-full
